  ...
  return (
    <div className="relative w-full h-screen bg-black">
      <video
        ...
        onClick={togglePlay}
        src="https://youtu.be/0RXnxRHGc6Q?list=RD0RXnxRHGc6Q"
      >
      ...
      {showCaptions && (
        <div className="absolute bottom-16 right-4 bg-black bg-opacity-75 p-4 rounded-lg">
          <h4 className="text-white font-bold mb-2">Captions</h4>
